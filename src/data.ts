...
export const activities: Activity[] = [
  ...
  {
    id: "prob-human-library",
    categoryId: "problemsolving",
    category: "2. Problem Solving & Role-Play",
    jpCategory: "課題解決とロールプレイ",
    title: "(10) Human Library",
    jpTitle: "真人図書館",
    description: 'Instead of reading paper books, you "read" people by listening to their unique life stories and experiences. Example: Listening to a classmate share their story of living in a different country.',
    jpDescription: "紙の本を読む代わりに、人のユニークな人生経験やストーリーを聞くことで、その人を「読み」ます。例：海外生活の経験についてクラスメートの話を聞く。",
    steps: [
      "Preparation: \"Human Books\" (speakers) prepare a 5-minute story about a challenge or experience.",
      "Browsing: \"Readers\" (listeners) look at the list of titles and choose a \"Book\" to listen to.",
      "Reading Session: The \"Human Book\" tells their story to a small group of \"Readers.\"",
      "Q&A Session: \"Readers\" ask questions to understand the story more deeply.",
      "Rotation: After a signal, \"Readers\" move to a different station to \"read\" another \"Book.\""
    ],
    roles: [
      {
        name: "The Human Book",
        jpName: "語り手",
        phrases: [
          "The title of my story today is...",
          "A very important moment in my life was when...",
          "Does anyone have a question about my experience?"
        ]
      },
      {
        name: "The Reader",
        jpName: "聞き手",
        phrases: [
          "I chose to read your book because the title sounded...",
          "Could you tell me more about how you felt at that time?",
      ...
      },
      {
        ...
        jpName: "司会者",
        phrases: [
          "Welcome to our Human Library. Please find your first station.",
          "It is time to wrap up the discussion and rotate to the next book.",
          "Please remember to listen with an open mind and respect."
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    category: "2. Problem Solving & Role-Play",
    jpCategory: "課題解決とロールプレイ",
    title: "(12) Quick Problem-Solving",
    jpTitle: "短期課題解決",
  ...
  },
  {
    ...
    category: "3. Debate & Decision Making",
    jpCategory: "討論と意思決定",
    title: "(24) Mock Press Conference",
    jpTitle: "模擬記者会見",
